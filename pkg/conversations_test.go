...
const updatedConversationResponse = `{
	"date_updated": "2020-07-30T00:00:00Z",
	"friendly_name": "Friendly Conversation",
	"timers": {},
	"account_sid": "ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
...
func TestWillMakeRequestToCreateNewConversationSuccessfully(t *testing.T) {
	...
	response, err := twilio.CreateNewConversation(twiligo.ConversationOptions{})
...
func TestWillIncludeProperRequestBodyParametersWhenMakingRequestToCreateNewConversationSuccessfully(t *testing.T) {
	...
	twilio.CreateNewConversation(twiligo.ConversationOptions{
...
func TestWillMakeRequestToUpdateConversationSuccessfully(t *testing.T) {
	twilio := NewTestTwilio(func(req *http.Request) *http.Response {
		...
		return &http.Response{
			Body:       ioutil.NopCloser(bytes.NewBufferString(updatedConversationResponse)),
			StatusCode: http.StatusOK,
			Header:     make(http.Header),
		}
	})

	response, err := twilio.UpdateConversation("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", twiligo.ConversationOptions{})
...
func TestWillIncludeProperRequestBodyParametersWhenMakingRequestToUpdateConversationSuccessfully(t *testing.T) {
	twilio := NewTestTwilio(func(req *http.Request) *http.Response {
		body, _ := ioutil.ReadAll(req.Body)
		params, _ := url.ParseQuery(string(body))
...
func TestWillHandleErrorResponsesWhenMakingRequestToUpdateConversation(t *testing.T) {
	twilio := NewTestTwilio(func(req *http.Request) *http.Response {
		return &http.Response{
			Body:       ioutil.NopCloser(bytes.NewBufferString(attributesAreJsonResponse)),
			StatusCode: http.StatusBadRequest,
